...
def scrabble(word):
    """
    функция подсчета очков за буквы в переданном слове
    :param word: строка с переданным словом
    :return: кол-во очков за слово
    """
    # Здесь нужно написать код
    letters_dict = {'а': 1, 'в': 1, 'е': 1, 'ё': 1, 'и': 1, 'н': 1, 'о': 1, 'р': 1, 'с': 1, 'т': 1,
